...
3. [Experiments](./3_Experiments/README.md): summarizes robustness comparisons, perturbation statistics, ablation studies, visualizations, sensitivity analyses, Transformer results, ATRNet-STAR validation, and SAMPLE cross-domain evaluation.
