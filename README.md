...
3. [Experiments](./3_Experiments/README.md): follows Sections 3.1-3.5 of the experimental part, covering quantitative results, visualizations and feature analysis, comparative experiments, parameter sensitivity analysis, ablation studies, and supplementary experiments.
