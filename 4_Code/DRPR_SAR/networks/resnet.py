...
model_urls = {
    ...
    'resnet50': os.environ.get(
        'RESNET50_WEIGHTS',
        'pretrained/resnet/resnet50-19c8e357.pth',
    ),
    # 'resnet50': 'https://download.pytorch.org/models/resnet50-19c8e357.pth',
    # 'resnet50': './pretrained/mstar_resnet50.pth',
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=10, zero_init_residual=False,
        ...
        self.conv1 = nn.Conv2d(1, self.inplanes, kernel_size=7, stride=2, padding=3, #原始是3，RGB3通道
                               bias=False)
...
def _resnet(arch, block, layers, pretrained, num_classes,progress, **kwargs):
    ...
    if pretrained:
        pretrain_dict = torch.load(model_urls[arch], weights_only=False)
...
def resnet50(pretrained=True, num_classes=10,progress=True, **kwargs):
